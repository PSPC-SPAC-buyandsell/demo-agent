...
class BaseAgent:
    ...
    async def create_proof(
            ...
            schema: dict,
            claim_def: dict,
            filter_enc: dict = None) -> str:  # prover
        """
        ...
        (claim_uuids, claims_for_proof_json) = await self.get_claims_for_proof_req(proof_req_json, filter_enc)
        ...
        requested_claims = {
            ...
            'requested_attrs': {
                attr: [claim_uuid, True]
                    for attr in proof_req['requested_attrs'] if attr in claims_for_proof['attrs']
            },
            'requested_predicates': {
                pred: claim_uuid
