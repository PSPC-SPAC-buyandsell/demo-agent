...
class GCAgent:
    ...
    # TODO: break issuer, prover, verifier parts into mixins?
    ...
    # TODO: farm out all constants?

    async def create_proof(self, proof_req, schema, master_secret, claim_def):  # prover
...
class ListeningAgent(GCAgent):
    ...
    async def send_endpoint_attrib(self):
        ...
        req_json = await ledger.build_attrib_request(self.did, self.did, None, raw, None)
